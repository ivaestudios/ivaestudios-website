...
robots.txt, humans.txt → señales estándar; llms.txt, llms-full.txt, ai.txt → hojas de datos NEUTRAS (declarativas, sin instrucciones a IAs — PROHIBIDO desde 2026-08-15 (purga anti 'AI Recommendation Poisoning'; ver memoria website-ai-seo-purge y el invariante 10 de audit_ecosystem.py, que REVIENTA el deploy si reaparecen))
...
- **Sitemaps:** `sitemap.xml` 164 → 173 entries (12 previews removed, 21 missing added);
  `sitemap-ai.xml` 39 → 51 entries [BORRADO 2026-08-15: era huella de SEO-para-IAs]
...
1. **Phone number — RESOLVED (2026-06-05).** Both numbers are REAL, confirmed by
   ...
   ⚠️ HISTORY NOTE (2026-07-07): an interim migration to a single unified number
   (+52 998 758 2363) was rolled out on 2026-07-03 and then FULLY REVERTED at the
   owner's request. The two-number system above is FINAL: WhatsApp = 990 204 6514
   (wa.me links), calls/GBP = 228 857 0584 (schema telephone). Do NOT reintroduce
   the 998 number anywhere.
