...
(function () {
  ...
  var headerHTML = ''
    ...
    +   '<a href="' + homeHref + '" class="h-logo" aria-label="IVAE Studios"><img class="lg-navy" src="/images/logo-ivae-h-navy.png" alt="IVAE Studios" decoding="async"/><img class="lg-cream" src="/images/logo-ivae-h-cream.png" alt="IVAE Studios" aria-hidden="true" decoding="async"/></a>'
