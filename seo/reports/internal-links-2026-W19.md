# Internal Link Suggestions — 2026-W19

**Pages analyzed:** 95
**Suggestions:** 30 (similarity threshold: 0.2)

Top 30 new internal links to consider:

| # | From | → | To | Score | Suggested anchor |
|---|---|---|---|---|---|
| 1 | `post-maternity.html` | → | `post-engagement.html` | 0.88 | Engagement Session in Cancún & Riviera Maya: The Ultimate Gu |
...
| 11 | `post-honeymoon.html` | → | `post-luxury-yacht-photography-cancun.html` | 0.84 | Luxury Yacht Photography in Cancun: Capture Unforgettable Mo |
| 12 | `post-luxury-yacht-photography-cancun.html` | → | `post-honeymoon.html` | 0.84 | Honeymoon Photographer in Riviera Maya: Capture Your First A |
| 13 | `outfit-guide.html` | → | `post-engagement.html` | 0.83 | Engagement Session in Cancún & Riviera Maya: The Ultimate Gu |
| 14 | `post-luxury-yacht-photography-cancun.html` | → | `post-engagement.html` | 0.83 | Engagement Session in Cancún & Riviera Maya: The Ultimate Gu |
| 15 | `post-bachelorette-photoshoot-los-cabos.html` | → | `post-engagement.html` | 0.83 | Engagement Session in Cancún & Riviera Maya: The Ultimate Gu |
| 16 | `post-maternity.html` | → | `post-bachelorette-photoshoot-los-cabos.html` | 0.82 | Bachelorette Photoshoot in Los Cabos: The Complete Planning  |
| 17 | `post-bachelorette-photoshoot-los-cabos.html` | → | `post-maternity.html` | 0.82 | Maternity Photoshoot in Cancún & Riviera Maya: Your Complete |
| 18 | `post-couples.html` | → | `post-maternity.html` | 0.82 | Maternity Photoshoot in Cancún & Riviera Maya: Your Complete |
| 19 | `post-wedding-cancun.html` | → | `post-destination-wedding.html` | 0.82 | Destination Wedding Photographer in Riviera Maya: The Comple |
| 20 | `post-destination-wedding.html` | → | `post-wedding-cancun.html` | 0.82 | Wedding Photographer in Cancún: Your Complete Guide to a Dre |
...
1. Estos son sugerencias automáticas basadas en similaridad de contenido (Jaccard)
2. Revisa cada par y verifica que tenga sentido editorial
3. Si la página tiene markers <!-- AUTO-LINKS:start --> ... <!-- AUTO-LINKS:end -->,
   corre `python3 scripts/internal_link_optimizer.py --apply` para inyectar links
   automáticamente entre los markers (sin tocar copy hand-curated)
