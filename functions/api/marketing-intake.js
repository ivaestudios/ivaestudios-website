...
<tr><td align="center">
  ...
  <!-- Container -->
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:linear-gradient(180deg,#12121a 0%,#0a0a0f 100%);border:1px solid rgba(226, 77, 160,0.18);border-radius:16px;overflow:hidden;">

    <!-- Header with gradient bar -->
    <tr>
      <td style="background:linear-gradient(135deg,#E24DA0 0%,#BF54C0 40%,#9D5BE0 100%);height:4px;line-height:4px;font-size:0;">&nbsp;</td>
    </tr>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="font-family:'Outfit',sans-serif;font-weight:700;font-size:16px;color:#f0eee9;letter-spacing:-0.01em;">
              <span style="display:inline-block;width:10px;height:10px;background:linear-gradient(135deg,#E24DA0,#9D5BE0);border-radius:50%;margin-right:8px;vertical-align:middle;"></span>
              IVAE Marketing
            </td>
          </tr>
          <tr>
            <td style="padding-top:24px;">
              <span style="display:inline-block;font-family:'Courier New',monospace;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.22em;color:#E96FB4;padding:8px 16px;background:rgba(226, 77, 160,0.08);border:1px solid rgba(226, 77, 160,0.18);border-radius:100px;">
                ◉ BRIEF RECIBIDO
              </span>
            </td>
          </tr>
    ...
    <tr>
      <td style="padding:32px 40px 24px 40px;">
        <h1 style="font-family:'Outfit',sans-serif;font-size:38px;font-weight:900;line-height:1.05;letter-spacing:-0.025em;color:#f0eee9;margin:0 0 20px 0;">
          ...
          <span style="background:linear-gradient(105deg,#E24DA0 0%,#BF54C0 18%,#C878D0 28%,#9D5BE0 50%,#B06FE0 70%);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:#E24DA0;">El brief llegó.</span>
        </h1>
        <p style="font-family:'Outfit',sans-serif;font-size:16px;line-height:1.7;color:#F5A8D3;margin:0;">
    ...
    <tr>
      <td style="padding:8px 40px 16px 40px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-top:1px solid rgba(226, 77, 160,0.18);">

          <tr>
            <td style="padding:20px 0;border-bottom:1px solid rgba(226, 77, 160,0.10);" valign="top">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="100" valign="top" style="font-family:'Courier New',monospace;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.2em;background:linear-gradient(135deg,#E24DA0,#9D5BE0);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:#E96FB4;padding-top:2px;">
                    En 24h
                  </td>
            ...
            <td style="padding:20px 0;border-bottom:1px solid rgba(226, 77, 160,0.10);" valign="top">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td valign="top" style="font-family:'Outfit',sans-serif;font-size:15px;line-height:1.65;color:#f0eee9;">
                    Tu <strong style="color:#F5A8D3;">Social Strategy Snapshot</strong> personalizado — 6 páginas de análisis hechas a la medida de tu brief. Sin compromiso.
                  </td>
                </tr>
              </table>
            </td>
    ...
    <tr>
      <td style="padding:8px 40px 40px 40px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:linear-gradient(135deg,rgba(226, 77, 160,0.10),rgba(226, 77, 160,0.06));border:1px solid rgba(226, 77, 160,0.25);border-radius:12px;">
          <tr>
            <td style="padding:24px 28px;">
              <p style="font-family:'Outfit',sans-serif;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.15em;color:#E96FB4;margin:0 0 8px 0;">
                ¿Algo urgente?
              </p>
              <p style="font-family:'Outfit',sans-serif;font-size:15px;line-height:1.6;color:#f0eee9;margin:0;">
                Escríbenos directamente a <a href="mailto:info@ivaestudios.com" style="color:#F5A8D3;text-decoration:none;font-weight:500;border-bottom:1px solid rgba(226, 77, 160,0.4);">info@ivaestudios.com</a> o por <a href="https://wa.me/529902046514" style="color:#F5A8D3;text-decoration:none;font-weight:500;border-bottom:1px solid rgba(226, 77, 160,0.4);">WhatsApp</a>.
              </p>
            </td>
          </tr>
        </table>
    ...
    <!-- Footer -->
    <tr>
      <td style="background:rgba(226, 77, 160,0.04);padding:24px 40px;border-top:1px solid rgba(226, 77, 160,0.12);">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="font-family:'Courier New',monospace;font-size:10px;text-transform:uppercase;letter-spacing:0.2em;color:#6b6580;line-height:1.7;">
              ...
              <a href="https://ivaestudios.com/es/manejo-redes-sociales" style="color:#E96FB4;text-decoration:none;">ivaestudios.com</a>
            </td>
          </tr>
        </table>
      </td>
