...
(function () {
  ...
  var D = {
    ...
    '¿Nueva agencia o marca? Crea tu cuenta gratis': 'New agency or brand? Create your free account',
    '¿Tu agencia te dio acceso?': 'Did your agency give you access?',
    'No crees cuenta. Entra con el usuario que te mandó.': "Don't create an account. Sign in with the username they sent you.",
    'Tu primer cliente': 'Your first client',
    'Tu marca o canal': 'Your brand or channel',
    '¿Qué eres?': 'What are you?',
    'Creador de contenido': 'Content creator',
    'Tu marca o canal, tu calendario, tus redes.': 'Your brand or channel, your calendar, your networks.',
    'Agencia de marketing': 'Marketing agency',
    'Varios clientes, cada uno con su acceso.': 'Several clients, each with their own login.',
