...
import { el, timeAgo, STATUSES } from '../api.js?v=202609121541';
import { icon } from '../shell/icons.js?v=202609121541';
import { openSheet } from '../shell/sheet.js?v=202609121541';
import * as store from '../shell/store.js?v=202609121541';
import * as cl from '../services/checklist.js?v=202609121541';
import { checklistFor, applyChecklistTemplate, contentTypeLabel } from './templates.js?v=202609121541';
...
export function mount(host, ed) {
  ...
  const unavailableEl = el('div', { class: 'edcheck__empty' }, [
    el('p', { class: 'muted', text: T('La checklist se activa cuando se aplique la actualización del servidor.', 'The checklist activates once the server update is applied.') }),
  ]);
  ...
  function maybeOfferAdvance() {
    ...
    ctx.toast(T('Checklist completa.', 'Checklist complete.'), {
      type: 'success',
      action: {
        label: T('Mover a Revisión', 'Move to Review'),
