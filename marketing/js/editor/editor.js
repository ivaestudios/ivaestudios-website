...
import { el, api, statusBadge, approvalBadge, fmtDate, fmtDateTime, isClientRole} from '../api.js?v=202609121545';
import { T } from '../shell/i18n.js?v=202609121545';
import { icon } from '../shell/icons.js?v=202609121545';
import { openSheet, pickFrom, openCount } from '../shell/sheet.js?v=202609121545';
import * as store from '../shell/store.js?v=202609121545';
import * as cl from '../services/checklist.js?v=202609121545';
import { createAutosave } from './autosave.js?v=202609121545';
import { textExpand } from '../ui/pickers.js?v=202609121545';
import { openActionsMenu } from './actions.js?v=202609121545';
import { mount as mountContenido } from './tab-contenido.js?v=202609121545';
import { mount as mountGuion } from './tab-guion.js?v=202609121545';
import { mount as mountChecklist } from './tab-checklist.js?v=202609121545';
import { mount as mountConversacion } from './tab-conversacion.js?v=202609121545';
import { mount as mountActividad } from './tab-actividad.js?v=202609121545';
...
async function openApprovalPicker(anchor) {
  ...
  const decision = await pickFrom({
    ...
    anchor,
    options: [
      { value: 'approved', label: T('Aprobado', 'Approved'), color: '#22c55e', sub: esCliente ? T('Queda lista y el equipo se entera.', 'Marks it ready and the team is notified.') : T('Esto fuerza la decisión del cliente', 'This overrides the client\'s decision'), current: cur === 'approved' },
