...
// ============================================================================
import { api, el, clear, timeAgo, fmtDateTime, initials, copyText } from '../api.js?v=202609240215';
import { toast } from '../shell/toast.js?v=202609240215';
import { icon } from '../shell/icons.js?v=202609240215';
import { T, isEN } from '../shell/i18n.js?v=202609240215';
...
function ensureCss() {
  ...
  link.rel = 'stylesheet';
  link.href = '/marketing/css/bandeja.css?v=202609240215';
