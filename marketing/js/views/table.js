...
import { el, clear, api, fmtDate, avatar } from '../api.js?v=202608010245';
import { T } from '../shell/i18n.js?v=202608010245';
import { icon } from '../shell/icons.js?v=202608010245';
import { isPast } from '../lib/dates.js?v=202608010245';
import * as viewsSvc from '../services/views.js?v=202608010245';
import {
...
} from '../table/columns.js?v=202608010245';
import * as grp from '../table/groups.js?v=202608010245';
import { createSelection } from '../table/selection.js?v=202608010245';
import {
  createQuickAddRow, createQuickAddButton, openQuickAddSheet, resetChain,
} from '../table/quickadd.js?v=202608010245';
