...
import { el, clear, api, fmtDate, avatar } from '../api.js?v=202609191545';
import { T } from '../shell/i18n.js?v=202609191545';
import { icon } from '../shell/icons.js?v=202609191545';
import { isPast } from '../lib/dates.js?v=202609191545';
import * as viewsSvc from '../services/views.js?v=202609191545';
import {
...
} from '../table/columns.js?v=202609191545';
import * as grp from '../table/groups.js?v=202609191545';
import { createSelection } from '../table/selection.js?v=202609191545';
import {
  createQuickAddRow, createQuickAddButton, openQuickAddSheet, resetChain,
} from '../table/quickadd.js?v=202609191545';
