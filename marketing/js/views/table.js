...
import { el, clear, api, fmtDate, avatar } from '../api.js?v=202609091246';
import { T } from '../shell/i18n.js?v=202609091246';
import { icon } from '../shell/icons.js?v=202609091246';
import { isPast } from '../lib/dates.js?v=202609091246';
import * as viewsSvc from '../services/views.js?v=202609091246';
import {
...
} from '../table/columns.js?v=202609091246';
import * as grp from '../table/groups.js?v=202609091246';
import { createSelection } from '../table/selection.js?v=202609091246';
import {
  createQuickAddRow, createQuickAddButton, openQuickAddSheet, resetChain,
} from '../table/quickadd.js?v=202609091246';
