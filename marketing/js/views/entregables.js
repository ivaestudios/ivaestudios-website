...
// ============================================================================
import { api, el, clear, toast } from '../api.js?v=202608071101';
import { icon } from '../shell/icons.js?v=202608071101';
import { T } from '../shell/i18n.js?v=202608071101';
import { openSheet, confirmar } from '../shell/sheet.js?v=202608071101';
...
function ensureCss() {
  ...
  link.rel = 'stylesheet';
  link.href = '/marketing/css/entregables.css?v=202608071101';
...
function buildPdfBtn(month, itemsDelMes) {
  return el('button', {
    ...
    onclick: async (e) => {
      ...
      try {
        const mod = await import('../lib/pdf-entregables.js?v=202608071101');
