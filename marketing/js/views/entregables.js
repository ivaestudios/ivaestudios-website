...
// ============================================================================
import { api, el, clear, toast } from '../api.js?v=202609082330';
import { icon } from '../shell/icons.js?v=202609082330';
import { T } from '../shell/i18n.js?v=202609082330';
import { openSheet, pickFrom, confirmar } from '../shell/sheet.js?v=202609082330';
// Apple 1.2: reportar contenido / bloquear autor desde cualquier comentario.
import { moderarComentario } from '../shell/moderacion.js?v=202609082330';
...
function ensureCss() {
  ...
  link.rel = 'stylesheet';
  link.href = '/marketing/css/entregables.css?v=202609082330';
...
function buildPdfBtn(month, itemsDelMes) {
  return el('button', {
    ...
    onclick: async (e) => {
      ...
      try {
        const mod = await import('../lib/pdf-entregables.js?v=202609082330');
