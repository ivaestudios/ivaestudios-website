...
import { openSheet, pickFrom, confirmar } from '../shell/sheet.js?v=202609072306';
// Apple 1.2: reportar contenido / bloquear autor desde cualquier comentario.
import { moderarComentario } from '../shell/moderacion.js?v=202609072306';
...
function ensureCss() {
  ...
  link.rel = 'stylesheet';
  link.href = '/marketing/css/entregables.css?v=202609072306';
...
function buildPdfBtn(month, itemsDelMes) {
  return el('button', {
    ...
    onclick: async (e) => {
      ...
      try {
        const mod = await import('../lib/pdf-entregables.js?v=202609072306');
