...
} from '../api.js?v=202609121521';
import { icon, iconMarca } from '../shell/icons.js?v=202609121521';
import { T } from '../shell/i18n.js?v=202609121521';
import { ACTION_LABELS, detalleEvento } from '../lib/actividad-fmt.js?v=202609121521';
import { confirmar } from '../shell/sheet.js?v=202609121521';
// Tarjeta compartida "Error + Reintentar" (la misma de Inicio / Mi trabajo).
import { errorCard } from '../ui/states.js?v=202609121521';
import { buildInsertUpdates } from '../kanban/move-sheet.js?v=202609121521';
// El panel del guion vive fuera: lo comparten esta vista y la Cuadricula.
import { abrirGuion, cerrarGuion, vaciarPortapapeles as vaciarPortapapelesEn } from '../lib/guion-drawer.js?v=202609121521';
...
} from '../lib/video-upload.js?v=202609121521';
...
function buildPdfContenidoBtn(key, rows) {
  ...
  return el('button', {
    ...
    onclick: async (e) => {
      ...
      btn.disabled = true;
      try {
        const mod = await import('../lib/pdf-contenido.js?v=202609121521');
        const { vozDeMarca } = await import('../lib/pdf-lienzo.js?v=202609121521');
