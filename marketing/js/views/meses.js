...
} from '../api.js?v=202608261514';
import { icon } from '../shell/icons.js?v=202608261514';
import { T } from '../shell/i18n.js?v=202608261514';
import { ACTION_LABELS, detalleEvento } from '../lib/actividad-fmt.js?v=202608261514';
// Capas de history del shell: el boton atras del telefono cierra la capa de
// arriba (panel de guion) en vez de salir de la app.
import { pushLayer } from '../shell/router.js?v=202608261514';
import { confirmar } from '../shell/sheet.js?v=202608261514';
// Tarjeta compartida "Error + Reintentar" (la misma de Inicio / Mi trabajo).
import { errorCard } from '../ui/states.js?v=202608261514';
import { buildInsertUpdates } from '../kanban/move-sheet.js?v=202608261514';
import { slidesFromPost, fieldsFromSlides, slideLabel, slideHint, slidePlaceholder, slidesToText, altsFromText, altsToText } from '../editor/slides.js?v=202608261514';
...
} from '../lib/video-upload.js?v=202608261514';
...
function buildPdfContenidoBtn(key, rows) {
  ...
  return el('button', {
    ...
    onclick: async (e) => {
      ...
      btn.disabled = true;
      try {
        const mod = await import('../lib/pdf-contenido.js?v=202608261514');
        const { vozDeMarca } = await import('../lib/pdf-lienzo.js?v=202608261514');
