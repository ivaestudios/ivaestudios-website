...
} from '../api.js?v=202608261256';
import { icon } from '../shell/icons.js?v=202608261256';
import { T } from '../shell/i18n.js?v=202608261256';
import { ACTION_LABELS, detalleEvento } from '../lib/actividad-fmt.js?v=202608261256';
// Capas de history del shell: el boton atras del telefono cierra la capa de
// arriba (panel de guion) en vez de salir de la app.
import { pushLayer } from '../shell/router.js?v=202608261256';
import { confirmar } from '../shell/sheet.js?v=202608261256';
// Tarjeta compartida "Error + Reintentar" (la misma de Inicio / Mi trabajo).
import { errorCard } from '../ui/states.js?v=202608261256';
import { buildInsertUpdates } from '../kanban/move-sheet.js?v=202608261256';
import { slidesFromPost, fieldsFromSlides, slideLabel, slideHint, slidePlaceholder, slidesToText, altsFromText, altsToText } from '../editor/slides.js?v=202608261256';
...
function buildPdfContenidoBtn(key, rows) {
  ...
  return el('button', {
    ...
    onclick: async (e) => {
      ...
      btn.disabled = true;
      try {
        const mod = await import('../lib/pdf-contenido.js?v=202608261256');
