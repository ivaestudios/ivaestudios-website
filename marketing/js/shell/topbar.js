...
import { api, el, clear, avatar, timeAgo, initials, copyText } from '../api.js?v=202608261256';
import * as store from './store.js?v=202608261256';
import { openSheet, pickFrom } from './sheet.js?v=202608261256';
import { toast } from './toast.js?v=202608261256';
import { icon } from './icons.js?v=202608261256';
import { openClientSwitcher } from './clientswitcher.js?v=202608261256';
import { T, isEN, setLang } from './i18n.js?v=202608261256';
// Apple 1.2: lista de personas bloqueadas desde el menú de cuenta.
import { abrirBloqueados } from './moderacion.js?v=202608261256';
import { getTheme, setTheme } from './theme.js?v=202608261256';
...
export function createTopbar({ root, router, selectClient, openSearch, openNotifications }) {
  ...
  const visibleTabs = isClient
    ? DESKTOP_TABS.filter((t) => t.id === 'meses' || t.id === 'calendario' || t.id === 'entregables' || t.id === 'marca' || (t.id === 'metricas' && clientSeesMetrics))
    : DESKTOP_TABS;
