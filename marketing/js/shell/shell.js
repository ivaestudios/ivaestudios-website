...
import { api, el, clear } from '../api.js?v=202609211519';
import { setRoleDefault } from './theme.js?v=202609211519';
import { vigilarSegmentados } from './segfade.js?v=202609211519';
import * as store from './store.js?v=202609211519';
import * as prefs from './prefs.js?v=202609211519';
import * as router from './router.js?v=202609211519';
import { openSheet, pickFrom, closeAll, confirmDiscard } from './sheet.js?v=202609211519';
import { toast } from './toast.js?v=202609211519';
import { icon } from './icons.js?v=202609211519';
import * as iconsMod from './icons.js?v=202609211519';
import { createTopbar } from './topbar.js?v=202609211519';
import { createBottomNav } from './bottomnav.js?v=202609211519';
import { createSearch } from './search.js?v=202609211519';
import { createNotifications } from './notifications.js?v=202609211519';
import { T } from './i18n.js?v=202609211519';
import * as version from './version.js?v=202609211519';
import * as tienda from './tienda.js?v=202609211519';
import * as pickers from '../ui/pickers.js?v=202609211519';
import * as dnd from '../ui/dnd.js?v=202609211519';
...
async function installStoreUpdateWatch() {
  ...
  bar.append(
    el('span', {
      class: 'update-bar__txt',
      text: T(
        `Hay una versión nueva de la app (${nueva.tienda}).`,
    ...
    cap.innerHTML = `
      <div class="eulagate__card" role="dialog" aria-modal="true" aria-labelledby="eulagate-t">
        ...
        <div class="eulagate__body" tabindex="0">
          ...
          derecha.</p>
          <p><a href="/marketing/terminos" target="_blank" rel="noopener">Leer los Términos completos</a>
